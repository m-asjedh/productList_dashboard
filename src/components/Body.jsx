  ...
  return (
    <div className="w-full mx-auto px-4 py-12 relative">
        ...
        <div>
          ...
          <div className="flex justify-between flex-wrap">
            <button
              ...
              className="m-1 rounded-xl px-5 py-1 border border-orange-600 text-black hover:bg-orange-600 hover:text-white"
            >
              All
            </button>
            <button
      ...
      <ReactPaginate
        ...
        activeClassName={"bg-orange-500 text-white p-2 rounded"}
